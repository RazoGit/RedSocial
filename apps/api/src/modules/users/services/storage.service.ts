...
import { S3_CLIENT } from "../users.constants";

/**
 * Fachada de almacenamiento de objetos (RF-4). Encapsula S3Client para que
 * el resto del modulo no conozca AWS SDK y los tests puedan sustituirla.
 * En dev apunta a MinIO (forcePathStyle); en prod, a R2/S3 via env S3_*.
 */
@Injectable()
export class StorageService {
  ...
  /** URL GET firmada para servir el objeto sin proxy intermedio. */
